...
import (
	...
	"errors"
	"fmt"
	"github.com/drinkin/migrate/migrate/direction"
	"go/token"
	"io/ioutil"
	"path"
	"regexp"
...
func LinesBeforeAndAfter(data []byte, line, before, after int, lineNumbers bool) []byte {
	// TODO(drinkin): Trim empty lines at the beginning and at the end
	// TODO(drinkin): Trim offset whitespace at the beginning of each line, so that indentation is preserved
